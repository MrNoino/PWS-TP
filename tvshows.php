...
if(isset($_SESSION["watch_a_save_lang"])){
    ...
    if(file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_nav_". $_SESSION["watch_a_save_lang"] .".php") && file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_tvshows_". $_SESSION["watch_a_save_lang"] .".php") && file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_footer_". $_SESSION["watch_a_save_lang"] .".php")){
        ...
        include_once("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_tvshows_". $_SESSION["watch_a_save_lang"] .".php");
    ...
    //senao
        ...
        include_once("resources/languages/pt-PT/i18n_tvshows_pt-PT.php");
...
<head>
    ...
    <link href="./styles/tvshows.css" rel="stylesheet">
...
<body>
    ...
    <?php
        ...
        if(isset($_SESSION["watch_a_save_user_id"])){
            ...
            echo '<a href="./new-tvshow.php"><div class="position-fixed bottom-0 end-0"><button class="btn btn-outline-info rounded-btn"><span class="bi bi-plus-circle"></span></button></div></a>';
