...
if(isset($_SESSION["watch_a_save_lang"])){
    ...
    if(file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_nav_". $_SESSION["watch_a_save_lang"] .".php") && file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_actors_". $_SESSION["watch_a_save_lang"] .".php") && file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_footer_". $_SESSION["watch_a_save_lang"] .".php")){
        ...
        include_once("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_actors_". $_SESSION["watch_a_save_lang"] .".php");
    ...
    //senao
        ...
        include_once("resources/languages/pt-PT/i18n_actors_pt-PT.php");
...
<body>
    ...
    <main class="container mt-4 mb-5">
        ...
        <div class="col-12"><h2><?php echo $most_popular ?></h3></div>
        ...
        <?php
            ...
            foreach($popular as $person){
                ...
                echo '<div class="col">
                        ...
                        <a class="no-decoration" href="./actor.php?actorId=' . $person->getId() . '">
                            <div class="card card-height">

                                <img src="https://www.themoviedb.org/t/p/w600_and_h900_bestv2/'. $person->getProfilePath() .'" class="card-img-top" alt="Foto de perfil do actor/actriz - ' . $person->getName() .'">
    ...
    <?php
        ...
        if(isset($_SESSION["watch_a_save_user_id"])){
            ...
            echo '<a href="./new-actor.php"><div class="position-fixed bottom-0 end-0"><button class="btn btn-outline-info rounded-btn"><span class="bi bi-plus-circle"></span></button></div></a>';
