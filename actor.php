...
if(isset($_SESSION["watch_a_save_lang"])){
    ...
    if(file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_nav_". $_SESSION["watch_a_save_lang"] .".php") && file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_actor_". $_SESSION["watch_a_save_lang"] .".php") && file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_footer_". $_SESSION["watch_a_save_lang"] .".php")){
        ...
        include_once("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_actor_". $_SESSION["watch_a_save_lang"] .".php");
    ...
    //senao
        ...
        include_once("resources/languages/pt-PT/i18n_actor_pt-PT.php");
...
if(isset($_GET["actorId"]) && !empty($_GET["actorId"])){

    $actor = $client->getPeopleApi()->getPerson($_GET["actorId"]);
...
<head>
    ...
    <title>
        <?php echo $document_title . (isset($actor) ? $actor["name"] : $default_title) ?>
    </title>
</head>
    ...
    <main class="container mt-4 mb-5">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <img class="rounded img-fluid" src="https://www.themoviedb.org/t/p/w600_and_h900_bestv2/<?php echo $actor["profile_path"]; ?>" alt="Foto de perfil - <?php echo $actor["name"]; ?>">

            </div>

            <div class="col-12 col-md-6 col-lg-8">

                <h2 class="text-center text-primary mt-3"><?php echo $actor["name"] ?></h2>

                <p class="p-2 mt-5">
                    
                    <?php echo "<strong>" . $birthdate_label . ":</strong> "  . $actor["birthday"] ?>
                    
                </p>

                <p class="p-2"> 
                    
                    <?php echo "<strong>" . $birthplace_label . ":</strong> "  . $actor["place_of_birth"] ?>
                
                </p>

                <p class="p-2"> 
                    
                    <?php echo "<strong>" . $biography_label . ":</strong> "  . $actor["biography"] ?>
