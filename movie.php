...
##############################################
##                                          ##
## Título: Watch a Save - Movie             ##
##                                          ##
##############################################
##                                          ##
## Descrição: Página Movie do website Watch ##
...
require_once("./lib/controller/handle_movies.php");
...
if(isset($_SESSION["watch_a_save_lang"])){
    ...
    if(file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_nav_". $_SESSION["watch_a_save_lang"] .".php") && file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_movie_". $_SESSION["watch_a_save_lang"] .".php") && file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_footer_". $_SESSION["watch_a_save_lang"] .".php")){
        ...
        include_once("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_movie_". $_SESSION["watch_a_save_lang"] .".php");
    ...
    //senao
        ...
        include_once("resources/languages/pt-PT/i18n_movie_pt-PT.php");
...
if(isset($_GET["movieId"]) && !empty($_GET["movieId"])){
    ...
    $movie = $client->getMoviesApi()->getMovie($_GET["movieId"]);
    
    $credits = $client->getMoviesApi()->getCredits($_GET["movieId"]);
    ...
    foreach($credits["crew"] as $crew_member){
        ...
        if($crew_member["department"] === "Directing" && $crew_member["job"] === "Director"){

            $director = $crew_member;

        }

        if($crew_member["department"] === "Writing" && $crew_member["job"] === "Writer"){
...
if(isset($_GET["operation"], $_GET["movieId"])){

    $handle_movies = new handle_movies();

    switch($_GET["operation"]){
    
        case "watched":

            $handle_movies->set_watched($_GET["movieId"], $_SESSION["watch_a_save_user_id"]);

            break;

        case "unwatched":

            $handle_movies->unset_watched($_GET["movieId"], $_SESSION["watch_a_save_user_id"]);

            break;

        case "seelater":

            $handle_movies->set_seelater($_GET["movieId"], $_SESSION["watch_a_save_user_id"]);

            break;

        case "unseelater":

            $handle_movies->unset_seelater($_GET["movieId"], $_SESSION["watch_a_save_user_id"]);

            break;

        case "favorite":

            $handle_movies->set_favorite($_GET["movieId"], $_SESSION["watch_a_save_user_id"]);

            break;

        case "unfavorite":

            $handle_movies->unset_favorite($_GET["movieId"], $_SESSION["watch_a_save_user_id"]);
...
if(isset($_POST["evaluate"])){
    ...
    if(isset($_POST["comment"], $_POST["stars"])){
        ...
        $handle_movies->evaluate($_GET["movieId"], $_SESSION["watch_a_save_user_id"], $_POST["comment"], $_POST["stars"]);
...
$user_evaluation = $handle_movies->get_evaluation($_GET["movieId"], $_SESSION["watch_a_save_user_id"]);

$evaluations = $handle_movies->get_all_evaluations($_GET["movieId"]);

$watched = $handle_movies->get_watched($_GET["movieId"], $_SESSION["watch_a_save_user_id"]);

$seelater = $handle_movies->get_seelater($_GET["movieId"], $_SESSION["watch_a_save_user_id"]);

$favorite = $handle_movies->get_favorite($_GET["movieId"], $_SESSION["watch_a_save_user_id"]);
...
<head>
    ...
    <title>
        <?php echo $document_title . (isset($movie) ? $movie["title"] : $default_title); ?>
    </title>
</head>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="./movies.php"><?php echo $movies_link_content ?></a>
                    </li>
    ...
    <main class="container-fluid mt-4 mb-5">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <img class="rounded img-fluid" src="https://www.themoviedb.org/t/p/w600_and_h900_bestv2/<?php echo $movie["poster_path"]; ?>" alt="Poster do Filme - <?php echo $movie["title"]; ?>">

                <div class="d-flex d-flex justify-content-center">

                    <a href="?movieId=<?php echo $_GET["movieId"] . '&operation=' . ($watched ? 'unwatched' : 'watched') ?>"><button class="btn btn-outline-primary rounded-btn<?php echo ($watched ? " active" : "") ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php echo $watched_tooltip ?>"><span class="bi bi-eye"></span></button></a>

                    <a href="?movieId=<?php echo $_GET["movieId"] . '&operation=' . ($seelater ? 'unseelater' : 'seelater') ?>"><button class="btn btn-outline-secondary rounded-btn<?php echo ($seelater ? " active" : "") ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php echo $seelater_tooltip ?>"><span class="bi bi-bookmark"></span></button></a>

                    <a href="?movieId=<?php echo $_GET["movieId"] . '&operation=' . ($favorite ? 'unfavorite' : 'favorite') ?>"><button class="btn btn-outline-danger rounded-btn<?php echo ($favorite ? " active" : "") ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php echo $fav_tooltip ?>"><span class="bi bi-heart"></span></button></a>
            ...
            <div class="col-12 col-md-6 col-lg-8">
                ...
                <h2 class="text-center text-primary mt-3"><?php echo $movie["title"] ?></h2>
                ...
                <p class="p-2">
                    ...
                    <?php echo "<strong>" . $release_date . ":</strong> " . $movie["release_date"] ?>

                </p>

                <p class="p-2">

                    <?php echo "<strong>" . $duration_label . ":</strong> " . $movie["runtime"] . " " . $minutes ?>

                </p>

                <p class="p-2">
                
                    <?php echo "<strong>" . $overview_label . "</strong><br>" . $movie["overview"] ?>

                </p>

                <p class="p-2"> 
                    
                    <?php echo "<strong>" . $score_label . ":</strong> " . $movie["vote_average"] ?><span class="bi bi-star text-warning"></span>
                
                </p>

                <p class="p-2"> 
                    
                    <?php echo "<strong>" . $original_lang_label . ":</strong> "  . strtoupper($movie["original_language"]) ?>
                
                </p>

                <p class="p-2"> 
                    
                    <?php echo "<strong>" . $director_label . ":</strong> "  . $director["name"] ?>
            ...
            <div class="col-12">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <form class="row" method="POST" action="./movie.php?movieId=<?php echo $_GET["movieId"] ?>">

                        <div class="col-12 col-md-7 col-xl-8 mt-3">

                            <div class="input-group">

                                <input type="text" class="form-control" name="comment" placeholder="<?php echo $comment_placeholder ?>" maxlength="256" value="<?php echo (!Empty($user_evaluation["Comment"]) ? $user_evaluation["Comment"] : "" )?>"/>
                        ...
                        <div class="col-12 col-md-3 mt-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="stars" placeholder="<?php echo $stars_placeholder ?>" step="1" min="0" max="10" value="<?php echo (!Empty($user_evaluation["Stars"]) ? $user_evaluation["Stars"] : "" )?>"/>
                        ...
                        <div class="col-12 col-md-2 col-xl-1 d-flex justify-content-center mt-3">
                            ...
                            <input type="submit" class="btn btn-primary w-100" name="evaluate" value="<?php echo $evaluate_label ?>" />
                    ...
                    echo '<div class="col-12">
                                ...
                                <div class="container-fluid mt-5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12"><h4>'. $writers_label .'</h4></div>
                ...
                foreach($writers as $writer){
                    ...
                    echo '<div class="col">
                            ...
                            <div class="card card-height">
                                ...
                                <img src="' . (Empty($writer["profile_path"]) ? "resources/assets/noimage.png" : "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/" . $writer["profile_path"]) . '" class="card-img-top" alt="Foto de perfil - ' . $writer["name"] .'">
