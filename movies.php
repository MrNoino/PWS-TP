...
##############################################
##                                          ##
## Título: Watch a Save - Movies            ##
##                                          ##
##############################################
##                                          ##
## Descrição: Página Movies do website      ##
## Watch a Save, trabalho prático da        ##
## cadeira de Programção Web Servidor no    ##
## CTeSP de TPSI                            ##
##                                          ##
##############################################
##                                          ##
...
if(isset($_SESSION["watch_a_save_lang"])){
    ...
    if(file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_nav_". $_SESSION["watch_a_save_lang"] .".php") && file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_movies_". $_SESSION["watch_a_save_lang"] .".php") && file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_footer_". $_SESSION["watch_a_save_lang"] .".php")){
        ...
        include_once("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_movies_". $_SESSION["watch_a_save_lang"] .".php");
    ...
    //senao
        ...
        include_once("resources/languages/pt-PT/i18n_movies_pt-PT.php");
...
<body>
    ...
    <main class="container mt-4 mb-5">
        ...
        <div class="col-12"><h2><?php echo $most_populars ?></h3></div>
        ...
        <div class="col-12 mt-5"><h2><?php echo $best_evaluation ?></h3></div>
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xxl-5 g-3">
    ...
    <?php
        ...
        if(isset($_SESSION["watch_a_save_user_id"])){
            ...
            echo '<a href="./new-movie.php"><div class="position-fixed bottom-0 end-0"><button class="btn btn-outline-info rounded-btn"><span class="bi bi-plus-circle"></span></button></div></a>';
