...
include_once("./lib/controller/handle_actors.php");
...
if(isset($_SESSION["watch_a_save_lang"])){
    ...
    if(file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_nav_". $_SESSION["watch_a_save_lang"] .".php") && file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_new-actor_". $_SESSION["watch_a_save_lang"] .".php") && file_exists("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_footer_". $_SESSION["watch_a_save_lang"] .".php")){
        ...
        include_once("resources/languages/". $_SESSION["watch_a_save_lang"] ."/i18n_new-actor_". $_SESSION["watch_a_save_lang"] .".php");
    ...
    //senao
        ...
        include_once("resources/languages/pt-PT/i18n_new-actor_pt-PT.php");
...
if(isset($_POST["add_actor"])){
    ...
    if(isset($_POST["name"], $_POST["birthdate"], $_POST["gender"])  && !Empty($_POST["name"]) && !Empty($_POST["birthdate"]) && !Empty($_POST["gender"])){

        $handle_actors = new handle_actors();

        $handle_actors->add_actor($_POST["name"], (isset($_POST["biography"]) && !Empty($_POST["biography"]) ? $_POST["biography"] : NULL), (isset($_POST["birth_place"]) && !Empty($_POST["birth_place"]) ? $_POST["birth_place"] : NULL), $_POST["birthdate"], $_POST["gender"], (isset($_FILES["photo"]) && $_FILES["photo"]["size"] > 0 ? $_FILES["photo"] : NULL));

        if($handle_actors->get_code() !== 200){
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="./actors.php"><?php echo $actors_link_content ?></a>
                    </li>
    ...
    <main class="container mt-4 mb-5">
        ...
        <div class="row justify-content-center">
            ...
            <h2 class="text-center text-primary"><?php echo $new_actor_label ?></h2>
        ...
        <div class="row justify-content-center mt-5">
            ...
            <form method="POST" class="col-12 col-md-6 col-xl-4" enctype="multipart/form-data">
                ...
                <label for="input-biography" class="form-label mt-4"><?php echo $biography_label ?></label>
                    
                <textarea class="form-control mh-25" id="input-biography" name="biography" max="2048" placeholder="<?php echo $biography_placeholder ?>"></textarea>

                <label for="input-birth-place" class="form-label mt-4"><?php echo $birth_place_label ?></label>
                    
                <input type="text" class="form-control" id="input-birth-place" name="birth_place" placeholder="<?php echo $birth_place_placeholder ?>"/>

                <label for="input-birthdate" class="form-label mt-4"><?php echo $birthdate_label ?><span class="text-danger">*</span></label>
                    
                <input type="date" class="form-control<?php echo (isset($error) ? " is-invalid" : ""); ?>" id="input-birthdate" name="birthdate" required/>

                <label for="gender-select" class="form-label mt-4"><?php echo $gender_label ?><span class="text-danger">*</span></label>
                    
                <select class="form-select<?php echo (isset($error) ? " is-invalid" : ""); ?>" id="gender-select" name="gender" required>
                ...
                <label for="input-photo" class="form-label mt-4"><?php echo $photo_label ?></label>
                ...
                <input type="submit" class="btn btn-primary w-100 mt-5" name="add_actor" value="<?php echo $add_actor_label ?>"/> 
